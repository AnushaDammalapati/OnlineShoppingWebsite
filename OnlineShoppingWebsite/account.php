...
<html class="no-js" lang="en">
  <head>
    ...
    <title>My Account || Anusha saree Store</title>
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">Anusha saree Store</a></h1>
        </li>
    ...
    <form method="POST" action="update.php" style="margin-top:30px;">
      <div class="row">
        <div class="small-12">
            ...
            <div class="small-8 columns end">
              <?php
                ...
                if($result) {
                  ...
                  echo '<input type="text" id="right-label" placeholder="'. $obj->firstname. '" name="firstname">';
                  ...
                  echo '<input type="text" id="right-label" placeholder="'. $obj->lastname. '" name="lastname">';
		  ...
		  <div class="row" style="margin-top:30px;">
		  <p>Click on below "Reset Your Password" button to upate password</p>
		  <p>
